...
static int tee_close(hw_device_t *dev) {
    keymaster0_device_t *keymaster0_dev = (keymaster0_device_t *) dev;
    if (keymaster0_dev != NULL) {
        CK_SESSION_HANDLE handle = reinterpret_cast<CK_SESSION_HANDLE>(keymaster0_dev->context);
